...
def main():
    ...
    tp_pre = map_events_unique(df_pre, ATTACK_SCENARIOS, filter_ip=args.attacker)
    tp_post = map_events_unique(df_post, ATTACK_SCENARIOS, filter_ip=args.attacker)
    fp_pre = map_events_unique(df_pre, QUIET_ACTIVITIES, exclude_ip=args.attacker)
    fp_post = map_events_unique(df_post, QUIET_ACTIVITIES, exclude_ip=args.attacker)
